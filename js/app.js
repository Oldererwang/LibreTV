// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ruyi","dyttzy","hwba","ffzy","lzzy","bfzy","qiqikp","heimuer","mdzy","mozhua","wolong","tyyszy","ikunzy","zy360","wujin","zuida","dbzy","jisu"]'); // 默认选中资源
